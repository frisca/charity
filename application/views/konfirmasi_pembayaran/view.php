                    ...
                    <div class="card card-small mb-4">
                        ...
                        <?php if($this->session->flashdata('success') != ""){ ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $konfirmasi_pembayaran->bankDonatur;?>" class="form-control form-control-line" name="bankDonatur" required disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">No.Rekening Pengirim</label>
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $konfirmasi_pembayaran->noRekPengirim;?>" class="form-control form-control-line" name="noRekPengirim" required disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Nama Pengirim</label>
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $konfirmasi_pembayaran->namaPengirim;?>" class="form-control form-control-line" name="namaPengirim" required disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Bank Transfer Tujuan</label>
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $konfirmasi_pembayaran->bankTransferTujuan;?>" class="form-control form-control-line" name="bankTransferTujuan" required disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">No.Rekening Tujuan</label>
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $konfirmasi_pembayaran->noRekTujuan;?>" class="form-control form-control-line" name="noRekTujuan" required disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Nama Penerima</label>
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $konfirmasi_pembayaran->namaPenerima;?>" class="form-control form-control-line" name="namaPenerima" required disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Total Dana</label>
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $konfirmasi_pembayaran->jumlah;?>" class="form-control form-control-line" name="jumlah" required disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Tanggal Transfer</label>
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo date('d/m/Y', strtotime($konfirmasi_pembayaran->transferDate));?>" class="form-control form-control-line" name="transferDate" required id="joinDate" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $konfirmasi_pembayaran->description;?>" class="form-control form-control-line" name="description" required disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
