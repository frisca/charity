                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title" style="margin-bottom: 25px;">Daftar Admin</h4>
                                    ...
                                    <table id="example" class="table table-striped table-bordered" style="margin-top: 30px;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('admin/views/' . $value->idUser);?>">
                                                        <button class="btn btn-success"><i class="ti-search"></i></button>
                                                    </a>
                                                    <a href="<?php echo base_url('admin/edit/' . $value->idUser);?>">
                                                        <button class="btn btn-warning"><i class="mdi mdi-border-color"></i></button>
                                                    </a>
                                                    <a href="<?php echo base_url('admin/delete/' . $value->idUser);?>">
