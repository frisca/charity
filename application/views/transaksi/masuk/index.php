                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url('transaksi_masuk/approve/' . $value->idTransaksiMasuk);?>">
                                                <button class="btn btn-primary"><i class="material-icons">check</i></button>
                                            </a>
                                            <a href="<?php echo base_url('transaksi_masuk/reject/' . $value->idTransaksiMasuk);?>">
                                                <button class="btn btn-primary" style="background: green;"><i class="material-icons">close</i></button>
                                            </a>
                                            <?php } ?>
                                        </td>
                                    </tr>
