                    ...
                    <div class="card card-small mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" value="<?php echo $transaksi->nama;?>" class="form-control form-control-line" name="beasiswa" disabled id="beasiswa">
                                    <input type="hidden" value="<?php echo $transaksi->id_beasiswa;?>" class="form-control form-control-line" name="penerima_beasiswa">
                                </div>
                            </div>
                            <div class="form-group">
