                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title" style="margin-bottom: 25px;">Daftar Role</h4>
                                    ...
                                    <table id="example" class="table table-striped table-bordered" style="margin-top: 30px;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('role/views/' . $value->id_role);?>">
                                                        <button class="btn btn-success"><i class="ti-search"></i></button>
                                                    </a>
                                                    <a href="<?php echo base_url('role/edit/' . $value->id_role);?>">
                                                        <button class="btn btn-warning"><i class="mdi mdi-border-color"></i></button>
                                                    </a>
                                                    <a href="<?php echo base_url('role/delete/' . $value->id_role);?>">
