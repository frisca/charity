                ...
                <div class="col">
                    <div class="card card-small mb-4">
                        <div class="card-header border-bottom">
                            <h6 class="m-0">Tambah Pengumuman</h6>
                        ...
                        <?php if($this->session->flashdata('success') != ""){ ?>
                            ...
                            <?php } ?>                                
                            <form class="form-horizontal form-material" method="post" action="<?php echo base_url('pengumuman/processAdd');?>">
                                <div class="form-group">
                                    <label class="col-md-12">Judul</label>
                                    <div class="col-md-12">
                                        <input type="text" value="" class="form-control form-control-line" name="judul" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="" class="form-control form-control-line" name="createdDate" id="joinDate" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Isi</label>
                                    <div class="col-md-12">
                                        <textarea cols="80" id="edi" name="isi" rows="10" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
